...
class DynamoDBHighLevelResource(object):
    def __init__(self, *args, **kwargs):
        ...
        self.meta.client.meta.events.register('provide-client-params.dynamodb')

        self._injector = TransformationInjector()
        # Apply the handler that generates condition expressions including
        # placeholders.
        self.meta.client.meta.events.register('before-parameter-build.dynamodb')
        ...
        self.meta.client.meta.events.register('after-call.dynamodb')
        ...
        self.meta.client.meta.events.register('docs.*.dynamodb.*.complete-section')
