...
class Session(object):
    ...
    def _register_default_handlers(self):
        ...
        # S3 customizations
        self._session.register('creating-client-class.s3')
        self._session.register('creating-resource-class.s3.Bucket')
        self._session.register('creating-resource-class.s3.Object')
        self._session.register('creating-resource-class.s3.ObjectSummary')

        # DynamoDb customizations
        self._session.register('creating-resource-class.dynamodb')
        self._session.register('creating-resource-class.dynamodb.Table')

        # EC2 Customizations
        self._session.register('creating-resource-class.ec2.ServiceResource')

        self._session.register('creating-resource-class.ec2.Instance')
