...
class S3RegionRedirector(object):
    ...
    def register(self, event_emitter=None):
        ...
        emitter.register('needs-retry.s3')
        emitter.register('before-call.s3')
...
class S3ArnParamHandler(object):
    ...
    def register(self, event_emitter):
        event_emitter.register('before-parameter-build.s3')
...
class S3EndpointSetter(object):
    ...
    def register(self, event_emitter):
        event_emitter.register('before-sign.s3')
...
class S3ControlEndpointSetter(object):
    ...
    def register(self, event_emitter):
        event_emitter.register('before-sign.s3-control')
...
class S3ControlArnParamHandler(object):
    ...
    def register(self, event_emitter):
        event_emitter.register('before-parameter-build.s3-control')
